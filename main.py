...
df = pd.read_excel(r"C:\Users\ASUS\Desktop\GUVI Data Science\Capstone Projects\GUVI Projects\Project - 3\FAOSTAT_data.xlsx")
...
# Footer
st.markdown("---")
st.markdown("Developed by **Balasai** | Capstone Project: *Predicting Crop Production Based on Agricultural Data*")
